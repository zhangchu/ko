...
{
	public function __construct($sTable, $sIdKey='', $sDBAgentName='', $sMCacheName='', $iMCacheTime=3600)
	{
		$this->_oDB = new Ko_Dao_DB($sTable, '', $sIdKey, $sDBAgentName, $sMCacheName, $iMCacheTime);
	}
